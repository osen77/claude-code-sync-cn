...
//!
//! Handles first-time setup detection, non-interactive initialization from
//! config files, and recovery of existing repositories.
//!
//! The interactive setup wizard lives in `handlers/setup.rs`.
